...
function user_status(x) {
    var y = x.split("__");
    return y[0] == 1 ?
        '<center><a href="'+baseurl+'users/deactivate/'+ y[1] +'"><span class="label label-success"><i class="fa fa-check"></i> Active</span></a></center>' :
        '<center><a href="'+baseurl+'users/activate/'+ y[1] +'"><span class="label label-danger"><i class="fa fa-times"></i> Inactive</span><a/></center>';
}

function banned_status(x) {
    var y = x.split("__");
    return y[0] != 1 ?
        '<center><span class="label label-success"><i class="fa fa-check"></i> False</span></center>' :
        '<center><span class="label label-danger"><i class="fa fa-times"></i> Banned</span></center>';
}